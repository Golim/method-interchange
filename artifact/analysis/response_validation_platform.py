...
def main() -> None:
    ...
    prepare.add_argument("--out-dir", default="results/response-validation")
    ...
    serve.add_argument("--study-dir", default="results/response-validation")
    ...
    report.add_argument("--study-dir", default="results/response-validation")
